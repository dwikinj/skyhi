<div class="text-white flex xl:my-20 xl:mx-12 2l:my-20 2l:mx-12 lg:my-20 lg:mx-12 my-10 mx-10">
    <div class="xl:w-[516px] space-y-4">
        ...
        <ul class="list-disc ml-4 text-[14px]">
            ...
            <li>Cross-Platform: Works seamlessly on laptops, tablets, and smartphones.</li>
        </ul>
        <h2 class="text-[20px]">Join SkyHi Today</h2>
        <p class="text-[14px]">Sign up now to experience the future of video communication. Whether for personal use or
            business, SkyHi is your go-to solution for seamless, high-quality video chats.</p>
        <h2 class="text-[20px]">Get Started</h2>
        <p class="text-[14px]">Create your free account and explore SkyHi's features. Welcome to the new era of video
            communication!</p>
    </div>
</div>
